...
describe('Company Contact View', function() {
  var page;

  beforeEach(function() {
    browser.get('/company/contact');
    page = require('./contact.po.js');
  });
  ...
  it('should have Company active in navbar', function() {
    expect(page.getActiveNavbarLink().getText()).toBe("Company");
  });
